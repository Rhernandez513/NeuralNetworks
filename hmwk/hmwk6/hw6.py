...
# def generate_images(data_loader,encoder,decoder,noise_factor=0.3):
def generate_images():
    count = 9
    r = [random.randint(0,len(val_data)) for i in range(count)]

    for i in range(count):
        img = val_data[r[i]][0].unsqueeze(0)
...
# TODO migrate image gen code 


# this script will accomplish the following:
# generte 9 random images of digits arranges in a 3x3 matrix
# labels are not important, include the images in the repor
